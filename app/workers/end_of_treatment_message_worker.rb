  ...
  def perform
    ...
    ending_treatment.each do |patient|
      I18n.with_locale(patient.locale) do
        patient.send_automated_message_to_patient(I18n.t("end_treatment_message_reminder"))
      end
    end
    ...
    recently_finished.each do |patient|
      I18n.with_locale(patient.locale) do
        ...
        patient.send_automated_message_to_patient(I18n.t("end_treatment_message_reminder")) if has_not_recieved_first_message

        days_since_end = (Date.current - patient.treatment_end_date).to_i.abs
