class PatientSerializer < ActiveModel::Serializer
    ...
    attributes :given_name, :family_name, :id, :full_name, :adherence, :percentage_complete, :days_in_treatment, :last_report, :treatment_start, :medication_schedule, :current_streak
