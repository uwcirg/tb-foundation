#This file if very similar to organization_sql.rb - need to figure out a way to factor out these queries and share across both
...
module DashboardSQL
  ...
  SELECT user_starts.id as user_id,  round( number_reports/days_since_start::decimal, 3 ) as adherence FROM 
    ...
    WHERE daily_reports.user_id IN (#{ALL_PATIENTS}) AND medication_reports.medication_was_taken = true
