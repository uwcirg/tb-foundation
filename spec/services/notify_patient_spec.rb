...
RSpec.describe NotifyPatient, type: :model do
  before(:all) do
  ...
  it ".medication_reminder sends a medication reminder" do
    ...
    NotifyPatient.new(@patients[0]).medication_reminder
  end
  ...
  it ".missed_three_days_reminder sends a reminder for 3 day" do
    ...
    NotifyPatient.new(@patients[0]).missed_three_days_reminder
  end
  ...
  it ".missed_seven_days_reminder sends a reminder for 7 day" do
    ...
    NotifyPatient.new(@patients[0]).missed_seven_days_reminder
  end
  ...
  it ".missed_thirty_days_reminder sends a reminder for 30 day" do
    ...
    NotifyPatient.new(@patients[0]).missed_thirty_days_reminder
  end
