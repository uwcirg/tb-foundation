...
RSpec.describe "/contact_tracing_surveys", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ContactTracingSurvey.create! valid_attributes
      get contact_tracing_surveys_url, headers: valid_headers, as: :json
  ...
  describe "GET /show" do
    it "renders a successful response" do
      contact_tracing_survey = ContactTracingSurvey.create! valid_attributes
      get contact_tracing_survey_url(contact_tracing_survey), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested contact_tracing_survey" do
        contact_tracing_survey = ContactTracingSurvey.create! valid_attributes
        patch contact_tracing_survey_url(contact_tracing_survey),
              params: { contact_tracing_survey: new_attributes }, headers: valid_headers, as: :json
        contact_tracing_survey.reload
        skip("Add assertions for updated state")
      end

      it "renders a JSON response with the contact_tracing_survey" do
        contact_tracing_survey = ContactTracingSurvey.create! valid_attributes
        patch contact_tracing_survey_url(contact_tracing_survey),
              params: { contact_tracing_survey: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the contact_tracing_survey" do
        contact_tracing_survey = ContactTracingSurvey.create! valid_attributes
        patch contact_tracing_survey_url(contact_tracing_survey),
              params: { contact_tracing_survey: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested contact_tracing_survey" do
      contact_tracing_survey = ContactTracingSurvey.create! valid_attributes
      expect {
        delete contact_tracing_survey_url(contact_tracing_survey), headers: valid_headers, as: :json
      }.to change(ContactTracingSurvey, :count).by(-1)
    end
  end
end
